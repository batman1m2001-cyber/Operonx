...
Example::
    ...
    from operonx.core.loggings import LOGGER, LogConfig, setup_logger
...
Extending with a custom handler (e.g. Kafka) from a sibling package::
    ...
    from operonx.core.loggings import HandlerConfig, register_handler
...
def register_handler(
    ...
    Example:
        # Trong package bên ngoài (operonx-loggings-kafka)
        from operonx.core.loggings import HandlerConfig, register_handler
...
LOGGER = setup_logger(LogConfig(name="operonx.core"))
