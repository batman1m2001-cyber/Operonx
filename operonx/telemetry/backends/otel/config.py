...
class OTELConfig(YamlModel):
    ...
    Example:
        ...
        client = ResourceHub.instance().get("otel:jaeger")
        ```
    """
    ...
    service_name: str = "operonx-workflow"
    ...
    def from_env(cls) -> "OTELConfig":
        ...
        Environment variables:
            ...
            - OTEL_SERVICE_NAME (optional, default: operonx-workflow)
        ...
        return cls(
            ...
            headers=headers,
            service_name=os.environ.get("OTEL_SERVICE_NAME", "operonx-workflow"),
