...
framework. See :mod:`operonx.app.serve.protocol`.
"""
...
def __getattr__(name):
    ...
    Keeps `import operonx.app.serve` working — and the protocol, registry
    ...
    """
    if name in ("build_app", "build_apps", "serve_manifest", "engine_for", "compile_graph"):
