...
if TYPE_CHECKING:
    ...
    from operon.telemetry.backends.otel import OTELConfig
...
class OTELTracer(ConfigurableTracer):
    ...
    Example:
        ```python
        from operon.telemetry import OTELTracer, OTELConfig
    ...
    def _make_client(self, config):
        from operon.telemetry.backends.otel import OTELClient
