...
Inherits from operon.core.tracing.Tracer. Flush runs in FlushWorker's
...
from operon.core.media import substitute_placeholder
from operon.telemetry.tracers._base import ConfigurableTracer
...
if TYPE_CHECKING:
    ...
    from operon.telemetry.backends.langfuse import LangfuseConfig
...
class LangfuseTracer(ConfigurableTracer):
    ...
    Example:
        ```python
        from operon.telemetry import LangfuseTracer, LangfuseConfig
    ...
    def _make_client(self, config):
        from operon.telemetry.backends.langfuse import LangfuseClient
