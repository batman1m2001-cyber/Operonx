...
Default path: ~/.operon/traces/ (configurable via path= or OPERON_TRACES_DIR env var).
"""
...
class LocalTracer(Tracer):
    ...
    Example:
        ...
        # Trace written to ~/.operon/traces/{request_id}.json
    ...
    def __init__(
        ...
        self._path = Path(path or os.environ.get("OPERON_TRACES_DIR", "~/.operon/traces")).expanduser()
