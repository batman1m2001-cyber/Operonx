...
class Scheduler:
    ...
    async def _run_once(
        ...
        async def _pump(op_name: str, ctx: tuple) -> None:
            ...
            nonlocal inflight
            op = g._ops[op_name]
            from operon.core.tracing.labels import _reset_gen_key, _set_gen_key
