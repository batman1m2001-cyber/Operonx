...
Ví dụ 1-2: Không cần API key (HushEyesTracer → gửi đến ui-hush-eyes server)
Ví dụ 3: Cần LANGFUSE keys trong .env

Học được:
- HushEyesTracer: gửi traces đến ui-hush-eyes server (Rust, web UI)
...
async def example_1_hush_eyes_tracer():
    """HushEyesTracer — Gửi traces đến ui-hush-eyes server."""
    print("=" * 50)
    print("Ví dụ 1: HushEyesTracer (ui-hush-eyes server)")
    print("=" * 50)
