...
Chạy: cd examples && uv run python ex03_llm_chat/bench.py
"""
...
async def main():
    ...
    print("=" * 55)
    await test_serve("Python", "ex03_llm_chat/serve_python.py", PORT_PY)

    print()
    print("=" * 55)
    print("2. Hush serve (Rust backend — Axum)")
    print("=" * 55)
    await test_serve("Rust", "ex03_llm_chat/serve_rust.py", PORT_RS)
