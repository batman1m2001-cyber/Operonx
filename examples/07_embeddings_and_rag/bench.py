...
Chạy: cd examples && uv run python 07_embeddings_and_rag/bench.py
"""
...
async def main():
    ...
    print("=" * 55)
    await test_serve("Python", "07_embeddings_and_rag/serve_python.py", PORT_PY)

    print()
    print("=" * 55)
    print("2. Hush serve (Rust backend — Axum)")
    print("=" * 55)
    await test_serve("Rust", "07_embeddings_and_rag/serve_rust.py", PORT_RS)
