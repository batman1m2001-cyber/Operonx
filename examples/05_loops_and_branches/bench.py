...
Chạy: cd examples && uv run python 05_loops_and_branches/bench.py
"""
...
async def main():
    ...
    print("=" * 55)
    await test_serve("Python", "05_loops_and_branches/serve_python.py", PORT_PY)

    print()
    print("=" * 55)
    print("2. Hush serve (Rust backend — Axum)")
    print("=" * 55)
    await test_serve("Rust", "05_loops_and_branches/serve_rust.py", PORT_RS)
