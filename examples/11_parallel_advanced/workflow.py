"""Shared workflow definitions for 11_parallel_advanced.

Defines fan-out/fan-in, generator iteration, and partial failure ops + graph builders.
Examples 1-3: no API keys required (pure compute).
Example 4: requires OPENAI_API_KEY (parallel LLM calls).
"""
