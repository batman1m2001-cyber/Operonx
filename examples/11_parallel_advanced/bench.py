...
Chạy: cd examples && uv run python 11_parallel_advanced/bench.py
"""
...
async def main():
    ...
    print("=" * 55)
    await test_serve("Python", "11_parallel_advanced/serve_python.py", PORT_PY)

    print()
    print("=" * 55)
    print("2. Hush serve (Rust backend — Axum)")
    print("=" * 55)
    await test_serve("Rust", "11_parallel_advanced/serve_rust.py", PORT_RS)
