"""Shared workflow definitions for 14_streaming_tracing.

Defines generator ops and graph builders for streaming pipelines.
No API key required for ops (Langfuse tracing optional).
"""
