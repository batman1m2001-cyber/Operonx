"""11 Parallel Advanced — Test serve modes: Python (FastAPI) and Rust (Axum).
...
Chạy: cd examples && uv run python ex11_parallel_advanced/bench.py
"""
...
ENDPOINTS = [
    ...
    ("/iteration", {"items": [1, 2, 3, 4, 5]}, "Iteration"),
    ("/partial-failure", {"items": [1, 2, 3, 4, 5, 6, 7]}, "Partial Failure"),
]
...
async def main():
    ...
    print("=" * 55)
    await test_serve("Python", "ex11_parallel_advanced/serve_python.py", PORT_PY)

    print()
    print("=" * 55)
    print("2. Hush serve (Rust backend — Axum)")
    print("=" * 55)
    await test_serve("Rust", "ex11_parallel_advanced/serve_rust.py", PORT_RS)
