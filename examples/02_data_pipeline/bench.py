...
Chạy: cd examples && uv run python 02_data_pipeline/bench.py
"""
...
async def main():
    ...
    print("=" * 55)
    await test_serve("Python", "02_data_pipeline/serve_python.py", PORT_PY)

    print()
    print("=" * 55)
    print("2. Hush serve (Rust backend — Axum)")
    print("=" * 55)
    await test_serve("Rust", "02_data_pipeline/serve_rust.py", PORT_RS)
