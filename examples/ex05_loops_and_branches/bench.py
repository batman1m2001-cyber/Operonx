...
Chạy: cd examples && uv run python ex05_loops_and_branches/bench.py
"""
...
async def main():
    ...
    print("=" * 55)
    await test_serve("Python", "ex05_loops_and_branches/serve_python.py", PORT_PY)

    print()
    print("=" * 55)
    print("2. Hush serve (Rust backend — Axum)")
    print("=" * 55)
    await test_serve("Rust", "ex05_loops_and_branches/serve_rust.py", PORT_RS)
