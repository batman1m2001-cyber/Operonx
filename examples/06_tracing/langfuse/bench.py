...
Chạy: cd examples && uv run python 06_tracing/langfuse/bench.py
"""
...
async def main():
    ...
    print("=" * 55)
    await test_serve("Python", "06_tracing/langfuse/serve_python.py", PORT_PY)

    print()
    print("=" * 55)
    print("2. Hush serve (Rust backend — Axum)")
    print("=" * 55)
    await test_serve("Rust", "06_tracing/langfuse/serve_rust.py", PORT_RS)
