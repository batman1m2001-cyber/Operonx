...
Chạy: cd examples && uv run python ex10_multi_model/bench.py
"""
...
async def main():
    ...
    print("=" * 55)
    await test_serve("Python", "ex10_multi_model/serve_python.py", PORT_PY)

    print()
    print("=" * 55)
    print("2. Hush serve (Rust backend — Axum)")
    print("=" * 55)
    await test_serve("Rust", "ex10_multi_model/serve_rust.py", PORT_RS)
