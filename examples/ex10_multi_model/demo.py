...
async def main():
    ...
    print("=" * 55)
    engine = Hush(build_parallel_comparison(), env=ENV_FILE, resources=RESOURCES_FILE)
    ...
    print("=" * 55)
    engine = Hush(build_cost_routing(), env=ENV_FILE, resources=RESOURCES_FILE)
    ...
    print("=" * 55)
    engine = Hush(build_load_balanced(), env=ENV_FILE, resources=RESOURCES_FILE)
    model_counts = {}
    for i in range(6):
    ...
    print("=" * 55)
    engine = Hush(build_fallback(), env=ENV_FILE, resources=RESOURCES_FILE)
    ...
    print("=" * 55)
    engine = Hush(build_ensemble(), env=ENV_FILE, resources=RESOURCES_FILE)
