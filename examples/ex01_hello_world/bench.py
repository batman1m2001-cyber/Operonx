...
Chạy: cd examples && uv run python ex01_hello_world/bench.py
"""
...
async def main():
    ...
    print("=" * 55)
    await test_serve("Python", "ex01_hello_world/serve_python.py", PORT_PY)

    print()
    print("=" * 55)
    print("2. Hush serve (Rust backend — Axum)")
    print("=" * 55)
    await test_serve("Rust", "ex01_hello_world/serve_rust.py", PORT_RS)
