...
Chạy: cd examples && uv run python ex02_data_pipeline/bench.py
"""
...
ENDPOINTS = [
    ...
    (
        "/text-pipeline",
        {"text": "Tri tue nhan tao dang thay doi cach chung ta song"},
        "Text Pipeline",
    ),
]
...
async def main():
    ...
    print("=" * 55)
    await test_serve("Python", "ex02_data_pipeline/serve_python.py", PORT_PY)

    print()
    print("=" * 55)
    print("2. Hush serve (Rust backend — Axum)")
    print("=" * 55)
    await test_serve("Rust", "ex02_data_pipeline/serve_rust.py", PORT_RS)
