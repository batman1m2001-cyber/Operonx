...
class TestRerankNode:
    ...
    def test_node_type(self):
        ...
        with patch("hush.providers.nodes.rerank.ResourceHub") as mock_hub:
            ...
            node = RerankNode(name="test_rerank", resource_key="bge-m3")
    ...
    def test_input_schema(self):
        ...
        with patch("hush.providers.nodes.rerank.ResourceHub") as mock_hub:
            ...
            node = RerankNode(name="input_test", resource_key="bge-m3")
    ...
    def test_output_schema(self):
        ...
        with patch("hush.providers.nodes.rerank.ResourceHub") as mock_hub:
            ...
            node = RerankNode(name="output_test", resource_key="bge-m3")
    ...
    async def test_process_string_documents(self):
        ...
        with patch("hush.providers.nodes.rerank.ResourceHub") as mock_hub:
            ...
            node = RerankNode(name="process_test", resource_key="bge-m3")
    ...
    async def test_process_dict_documents(self):
        ...
        with patch("hush.providers.nodes.rerank.ResourceHub") as mock_hub:
            ...
            node = RerankNode(name="dict_test", resource_key="bge-m3")
    ...
    async def test_process_empty_documents(self):
        ...
        with patch("hush.providers.nodes.rerank.ResourceHub") as mock_hub:
            ...
            node = RerankNode(name="empty_test", resource_key="bge-m3")
...
class TestRerankNodeIntegration:
    ...
    async def test_rerank_node_with_hub(self, hub):
        ...
        node = RerankNode(name="rerank", resource_key="bge-m3-onnx")
    ...
    async def test_rerank_node_with_pinecone(self, hub):
        ...
        node = RerankNode(name="rerank_pinecone", resource_key="bge-m3")
